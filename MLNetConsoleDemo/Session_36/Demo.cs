...
namespace MLNetConsoleDemo.Session_36
{
    class Demo
    {
        ...
        {
            Environment.SetEnvironmentVariable("TF_ENABLE_ONEDNN_OPTS",null);
        ...
        private static IEnumerable<InputModel> LoadImagesFromFolder(string datasetPath, bool loadBytes = true)
        {
